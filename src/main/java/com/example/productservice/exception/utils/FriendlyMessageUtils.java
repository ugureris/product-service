...
@Slf4j  //logları daha  okunabilir ve efektif sağlayan lombok anotasyonu
@UtilityClass // class arka tarafta final işaretleniyor, class'taki bütün metotlar, fieldlar, inner class'lar static işaretleniyor
public class FriendlyMessageUtils {
    ...
    public static String getFriendlyMessage(Language language, IFriendlyMessageCode messageCode) {
        ...
        try{
            ...
            ResourceBundle resourceBundle = ResourceBundle.getBundle(RESOURCE_BUNDLE_NAME, locale); //FriendlyMessage tr mi yoksa en mi olacağı seçiliyor
            messageKey = messageCode.getClass().getSimpleName() + SPECIAL_CHARACTER + messageCode;
            return resourceBundle.getString(messageKey); //FriendlyMessage_en bundle dosyasındaki FriendlyMessage__OK gibi bir değeri döndürüyor
